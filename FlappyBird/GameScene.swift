...
class GameScene: SKScene , SKPhysicsContactDelegate{
    ...
    func createScene(){
        ...
        getVariable(Variable: "Test")
        
        if(getSystemLanguage() == "ru"){
            U_Have = "Рекорд";
        } else {
            U_Have = "Highest Score";
        }
    ...
    func getSystemLanguage() -> String{
        ...
        if let preferredLanguage = NSLocale.preferredLanguages[0] as String? {
            ...
            if(Language.range(of:"en") == nil && Language.range(of:"ru") == nil){
                Language = "en";
            }
            
            if Language.range(of:"en") != nil {
                Language = "en";
            }
            
            if(Language.range(of:"ru") != nil){
                Language = "ru"
            }
        }
        return Language
